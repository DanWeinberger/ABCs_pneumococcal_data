...
```{r}
select_countries <- c('Australia','Austria','Czechia','Denmark','Finland','Ireland','Italy','Netherlands','Norway','Poland','Slovenia','Slovakia','United Kingdom')
...
st_db |> 
  filter( st =='19F' & country  %in% select_countries
          ) |>
